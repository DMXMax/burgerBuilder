...
const mapDispatchToProps=dispatch=>{
  ...
  return {
    ...
    onIngredientAdded: ingredient=>dispatch({type : actionType.INGREDIENT_ADD,ingredient}),   
    onIngredientRemoved: ingredient=>dispatch({type : actionType.INGREDIENT_REMOVE,ingredient})
